...
[Components]
Name: "python"; Description: "Python {#PyCurrent} x64 installer"; Types: full; Check: PythonInstalled()
...
Source: "E:\mesaplot-wininst\python-{#PyCurrent}.amd64.msi"; DestDir: "{tmp}"; Flags: ignoreversion; Components: "python"
...
; START PYTHON
Filename: "{sys}\msiexec.exe"; Parameters: "/i {tmp}\python-{#PyCurrent}.amd64.msi /qb ALLUSERS=1 ADDLOCAL=ALL TARGETDIR={sd}\python27"; WorkingDir: "{tmp}"; Check: PythonInstalled()
; END PYTHON
; START NUMPY
...
; END NUMPY
; START MATPLOTLIB
Filename: "{code:AddBackslash|{reg:HKLM\SOFTWARE\Python\PythonCore\2.7\InstallPath,|{reg:HKCU\Software\Python\PythonCore\2.7\InstallPath,|{sd}\python27}}}Scripts\pip.exe"; Parameters: "install matplotlib"
; END MATPLOTLIB
; START WXPYTHON
